...
public class ExpressProcess extends AbstractConfiguration
  ...
  public IUser getProcessOwnerUser() {
    if (processOwnerUser == null) {
      processOwnerUser = UserUtils.findUser(
          UserUtils.stripSharpCharacterFromSecurityMemberName(processOwner));
    }
