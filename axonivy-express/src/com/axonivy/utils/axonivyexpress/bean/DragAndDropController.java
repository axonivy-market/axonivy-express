...
public class DragAndDropController implements Serializable {
  ...
  private void displayFileUploadPositionNotice() {
    FacesMessage message = new FacesMessage(FacesMessage.SEVERITY_INFO, Ivy
        ...
        "");
    FacesContext.getCurrentInstance().addMessage("available-form-elements",
        message);
  }
  ...
  private void displayMaximumFileUploadElementError() {
    FacesMessage message = new FacesMessage(FacesMessage.SEVERITY_ERROR, Ivy
        .cms().co("/Labels/Messages/MaximumFileUploadElement"),
        "");
    FacesContext.getCurrentInstance().addMessage("available-form-elements",
        message);
  }
  ...
  public void setAvailableFormelements(
      List<Formelement> availableFormelements) {
  ...
  public void setFinalUsedFormelements(
      List<Formelement> finalUsedFormelements) {
