...
public class SecurityMemberDisplayNameUtils {
  ...
  public static String generateBriefDisplayNameForSecurityMember(
    ...
    return generateBriefDisplayNameForRole(securityMember.getDisplayName(),
  ...
  public static String generateBriefDisplayNameForUser(IUser user,
      String username) {
  ...
  public static String generateFullDisplayNameForUserDTO(UserDTO user) {
    ...
    String formattedUsername = stripSharpCharacterFromSecurityMemberName(
        user.getName());
    String displayName = null;
    if (StringUtils.isBlank(user.getDisplayName())) {
      displayName = String.format(FORMAT_WITHOUT_DISPLAY_NAME,
          Ivy.cms().co(NO_NAME_CMS), formattedUsername);
    } else {
      displayName = String.format(FORMAT_WITH_DISPLAY_NAME,
          user.getDisplayName(), formattedUsername);
      if (!user.isEnabled()) {
  ...
  private static String formatDisabledUser(String displayName) {
    return String.format(FORMAT_DISABLED_USER,
        Ivy.cms().co(DISABLED_USER_PREFIX_CMS), displayName);
  }
}
