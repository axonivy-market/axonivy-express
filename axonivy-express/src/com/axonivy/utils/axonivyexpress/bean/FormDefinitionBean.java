...
public class FormDefinitionBean implements Serializable {
  ...
  public FormElementType[] getInputFormElementTypes() {
    FormElementType[] elementTypes = { FormElementType.INPUT_TEXT,
        FormElementType.INPUT_NUMBER, FormElementType.INPUT_DATE };
    return elementTypes;
  }
  ...
  public String getTitle(String processName) {
    String stepName = Ivy.cms().co(
        "/Dialogs/com/axonivy/utils/axonivyexpress/WorkflowDefinition/FormDefinitionStep");
